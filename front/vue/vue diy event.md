...
```js
///use
<my-component :test-obj.sync="testObj" >

///my-component
<template>
    <input type="number"
      :value="testObj.name"
      placeholder="testObj姓名"
      @input="handleObjName"
    />

  <input type="number"
      :value="testObj.phone"
      placeholder="testObj手机号"
      @input="handleObjPhone"
    />
...
handleObjName(e){
      this.$emit('update:testObj', {
        ...this.testObj,
        name:e.target.value})
    },
    handleObjPhone(e){
      this.$emit('update:testObj', { ...this.testObj,
