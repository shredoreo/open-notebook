...
在使用webpack本地起服务的时候，由于已经配置好了上述的规则，所以history模式没有问题



# 路由组件传参

[观看 Vue School 的如何向路由组件传递 prop 的免费视频课程 (英文)](https://vueschool.io/lessons/how-to-pass-vue-router-params-as-props-to-components?friend=vuejs)
