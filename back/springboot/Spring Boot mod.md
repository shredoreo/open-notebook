...
@EnbaleConfigurationProperties（Class）
...
docker pull registry.docker-cn.com/library/xxx //使用国内镜像
3、根据镜像启动容器
...
```
docker run -e ES_JAVA_OPTS="-Xms256m -Xmx256m" -d -p 9200:9200 -p 9300:9300 --name ES01 1bca39c5a102
```
