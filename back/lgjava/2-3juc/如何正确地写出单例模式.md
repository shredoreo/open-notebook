> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [wuchong.me](http://wuchong.me/blog/2014/08/28/how-to-correctly-write-singleton-pattern/)

> 单例模式算是设计模式中最容易理解，也是最容易手写代码的模式了吧。

发表于 2014-08-28   |   分类于 [程序设计](http://wuchong.me/categories/%E7%A8%8B%E5%BA%8F%E8%AE%BE%E8%AE%A1/)   |   [](http://wuchong.me/blog/2014/08/28/how-to-correctly-write-singleton-pattern/#comments)  |   阅读次数

单例模式算是设计模式中最容易理解，也是最容易手写代码的模式了吧。但是其中的坑却不少，所以也常作为面试题来考。本文主要对几种单例写法的整理，并分析其优缺点。很多都是一些老生常谈的问题，但如果你不知道如何创建一个线程安全的单例，不知道什么是双检锁，那这篇文章可能会帮助到你。

[](#懒汉式，线程不安全 "懒汉式，线程不安全")懒汉式，线程不安全
-----------------------------------
...
[](#饿汉式-static-final-field "饿汉式 static final field")饿汉式 static final field
--------------------------------------------------------------------------
...
[](#静态内部类-static-nested-class "静态内部类 static nested class")静态内部类 static nested class
-----------------------------------------------------------------------------------
...
[![](https://img.alicdn.com/tfs/TB1.ajIlIbpK1RjSZFyXXX_qFXa-1004-541.png)](https://img.alicdn.com/tfs/TB1.ajIlIbpK1RjSZFyXXX_qFXa-1004-541.png)